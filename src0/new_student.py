...
class Ui_AddStudentForm(object):
    ...
    def retranslateUi(self, AddStudentForm):
        ...
        self.label_5.setText(_translate("AddStudentForm", "DoB:"))
        self.label_6.setText(_translate("AddStudentForm", "Gender:"))
        self.label_7.setText(_translate("AddStudentForm", "Address:"))
        self.label_2.setText(_translate("AddStudentForm", "Assign class:"))
        self.prt_enrty_form.setTitle(_translate("AddStudentForm", "Parent/Guardian details"))
        self.label_11.setText(_translate("AddStudentForm", "Title:"))
        self.label_12.setText(_translate("AddStudentForm", "Full names:"))
        self.label_13.setText(_translate("AddStudentForm", "Telephone  home:"))
        self.label_14.setText(_translate("AddStudentForm", "Telephone  Work:"))
        self.label_15.setText(_translate("AddStudentForm", "Email:"))
        self.label_16.setText(_translate("AddStudentForm", "Relationship"))
        self.pushButton_5.setText(_translate("AddStudentForm", "Upload csv"))
        self.pushButton_3.setText(_translate("AddStudentForm", "Add"))
        self.pushButton_4.setText(_translate("AddStudentForm", "Reset"))
        self.pushButton_2.setText(_translate("AddStudentForm", "Preview"))
