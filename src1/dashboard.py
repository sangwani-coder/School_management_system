...
class Ui_MainWindow(QDialog):
    def setupUi(self, MainWindow):
        ...
        self.display_all_Button = QtWidgets.QPushButton(self.verticalLayoutWidget, clicked=lambda: self.load_data('display'))
        font = QtGui.QFont()
        font.setFamily("MS PGothic")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.create_class_Button = QtWidgets.QPushButton(self.verticalLayoutWidget, clicked=lambda:self.change_window(4))
        font = QtGui.QFont()
        font.setFamily("MS PGothic")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.create_list_button = QtWidgets.QPushButton(self.verticalLayoutWidget, clicked=lambda:self.change_window(3))
        font = QtGui.QFont()
        font.setFamily("MS PGothic")
        font.setPointSize(11)
        font.setBold(False)
        ...
        # self.actionAdd.triggered.connect(self.change_window(5))
    ...
    def load_data(self, data, rows=1):
        try:
            import csv
            if data == "display":
                ...
                for std in ROWS:
                    tut = int(std["tuition"])
                    if tut < 4000:
                        tuition = "owing: " + str(4000 - tut) + " ZMW"
                    else:
                        tuition = "cleared"
                    ...
                    self.tableWidget.setItem(row, 8, QtWidgets.QTableWidgetItem(tuition))
                    row += 1
            elif data == 'fully_paid':
                self.tableWidget.clearContents()
                file = 'C:\\Users\\USER\\Documents\\student.csv'
                with open(file, 'r') as file:
                    csv_reader = csv.DictReader(file)
